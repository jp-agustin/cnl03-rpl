...
int main (int argc, char *argv[])
{
  ...
  positionAlloc->Add (Vector (500.0, 50.0, 0.0));
  ...
  positionAlloc2->Add (Vector (200.0, 50.0, 0.0));
  positionAlloc2->Add (Vector (210.0, 75.0, 0.0));
  positionAlloc2->Add (Vector (400.0, 50.0, 0.0));
  positionAlloc2->Add (Vector (350.0, 80.0, 0.0));
  positionAlloc2->Add (Vector (300.0, 90.0, 0.0));
  positionAlloc2->Add (Vector (250.0, 10.0, 0.0));
  positionAlloc2->Add (Vector (150.0, 40.0, 0.0));
  positionAlloc2->Add (Vector (450.0, 30.0, 0.0));
